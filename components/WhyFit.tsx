  ...
  return (
    <section className="relative px-5 py-20 sm:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <h2 className="reveal mt-3 max-w-2xl font-display text-[clamp(1.8rem,1.2rem+2.4vw,2.8rem)] font-extrabold leading-[1.1] tracking-[-1px] text-white">
          The way your team builds is how I <span className="gradient-text italic">already work.</span>
        </h2>
